object Formsftpserver: TFormsftpserver
  ...
  object ipfSFTPServer1: TipfSFTPServer
    DefaultAuthMethods = 'password,publickey'
    OnConnected = ipfSFTPServer1Connected
    OnConnectionRequest = ipfSFTPServer1ConnectionRequest
    OnDirCreate = ipfSFTPServer1DirCreate
    OnDirRemove = ipfSFTPServer1DirRemove
    OnDisconnected = ipfSFTPServer1Disconnected
    OnError = ipfSFTPServer1Error
    OnFileClose = ipfSFTPServer1FileClose
    OnFileOpen = ipfSFTPServer1FileOpen
    OnFileRemove = ipfSFTPServer1FileRemove
    OnSSHStatus = ipfSFTPServer1SSHStatus
    OnSSHUserAuthRequest = ipfSFTPServer1SSHUserAuthRequest
    Left = 600
    Top = 40
  end
end
